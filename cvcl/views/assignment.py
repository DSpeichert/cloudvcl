...
class AssignmentDetail(LoginRequiredMixin, DetailView):
    ...
    def get_queryset(self):
        return Assignment.objects.filter(course__in=self.request.user.instructs) | self.request.user.courses.filter(
...
class AssignmentUpdate(LoginRequiredMixin, UpdateView):
    ...
    def get_queryset(self):
        return Assignment.objects.filter(course__in=self.request.user.instructs)
