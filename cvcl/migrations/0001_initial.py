# -*- coding: utf-8 -*-
# Generated by Django 1.10.5 on 2017-03-08 02:25
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('limit_ram', models.IntegerField(default=0, verbose_name=b'RAM limit in bytes')),
                ('is_instructor', models.BooleanField(default=False)),
                ('is_admin', models.BooleanField(default=False)),
                ('images', models.ManyToManyField(to='cvcl.Image')),
            ],
        ),
        migrations.CreateModel(
            name='UserGroup',
