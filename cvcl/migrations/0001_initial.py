# -*- coding: utf-8 -*-
# Generated by Django 1.10.2 on 2017-03-10 04:56
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('courses', models.ManyToManyField(to='cvcl.Course')),
        ...
        migrations.AddField(
            model_name='course',
            name='instructor',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='instructs',
                                    to='cvcl.User'),
        ),
        migrations.AddField(
            model_name='course',
            name='students',
            field=models.ManyToManyField(to='cvcl.User'),
        ),
        migrations.AddField(
